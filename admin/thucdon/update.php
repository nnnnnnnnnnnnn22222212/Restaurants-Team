        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <form action="index.php?act=addmon" method="post" class="form-qlb">
              <div class="tong">
                      <label ><b>MÃ MÓN</b></label> 
                      <input type="text" name="idmon"> <br>
                      <label ><b>TÊN MÓN</b></label> 
                      <input type="text" placeholder="Nhập Tên" name="tenmon" value="<?=$tenmon?>"> <br>
                      <label ><b>ẢNH</b> </label>
