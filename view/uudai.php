        ...
        <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                <div class="text-center">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">ƯU ĐÃI</h5>
                    <h1 class="mb-5">Một số ưu đãi của chúng tôi</h1>
                </div>
                                        ...
                                        echo '
                                            <div class="testimonial-item bg-transparent border rounded p-4">
                                                ...
                                                <div class="d-flex align-items-center">
                                                            <img class="img-fluid flex-shrink-0 rounded-circle" src="'.$hinh.'" style="width: 100px; height: 100px;">
                                                            <div class="ps-3">
                                                                <h5 class="mb-1">Mã ưu đãi:'.$idud.'</h5>
                                                                <h5 class="mb-1">Số lượng: '.$soluong.'</h5>
                                                                <small> Trạng thái: '.$trangthai.' </small>
                                                            </div>
                                                </div>
                                            </div>';
                                    }
